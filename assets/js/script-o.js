document.addEventListener("DOMContentLoaded", function () {
    ...
    const tableOfcontentBody = document.querySelector(".hs-toc-wrap .toc-body");
    ...
    let searchForm = document.querySelector(".hs-menu-search-form");
    let svg1 =
    ...
    const toggleslideBtn = document.querySelector(".hs-menu-toggle-btn");
